        ...
        <div className="p-4 sm:p-5 border-t border-border/30">
          <div className="flex gap-2 items-center">
            ...
            <button
              ...
              className="p-3.5 sm:p-3 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 text-white disabled:opacity-50 transition-all shadow-lg shadow-amber-200/30 hover:shadow-amber-200/50 active:scale-95"
            >
